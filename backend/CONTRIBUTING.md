# Contributing to nimnear-api

Thank you for your interest in contributing to nimnear-api! This document provides guidelines and instructions for contributing.
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/nimnear-api.git
cd nimnear-api
...
- Open a discussion through the repository's configured community channel
- Check the repository's existing issues
