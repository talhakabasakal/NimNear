...
description: Document Go architectural patterns, base types, and conventions for the nimnear_backend project. Use when explaining architecture decisions, documenting base patterns, or creating architecture guides.
---

# Base Pattern Documentation Skill

Use this skill when documenting Go architectural patterns or explaining how base types and conventions work in the nimnear_backend project.
