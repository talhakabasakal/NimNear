---
name: nimnear-api implementation
overview: Bootstrap and implement the nimnear-api enterprise SaaS backend as a Phase 1 modular monolith with clean/hexagonal architecture, multi-tenancy, RBAC, API gateway, and core bounded contexts in Go.
todos:
  - id: bootstrap
...
# nimnear-api Implementation Plan
