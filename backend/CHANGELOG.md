...
All notable changes to the nimnear-api project will be documented in this file.
...
#### Postman Collection
- **Complete Postman collection** (`postman/nimnear-api.postman_collection.json`) with 37 requests
- **Postman environment** (`postman/nimnear-api-local.postman_environment.json`) with pre-configured variables
